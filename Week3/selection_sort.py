def get_index_index_of_smallest(L, i):
    """ (list, int) -> int

    Return the index of the smallest item in L[i:].

    >>> get_index_index_of_smallest([2, 7, 3, 5], 1)
    2
    """
...
def selection_sort(L):
    ...
    Sort the items of L into non_descending order.
    ...
    for i in range((len(L))):
        ...
        index_of_smallest = get_index_index_of_smallest(L, i)
